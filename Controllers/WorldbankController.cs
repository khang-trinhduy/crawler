...
{
    public class WorldbankController : SpidersController
    {
        public WorldbankController(CrawlerContext context, IConfiguration config) : base(context, config)
        {
        }
