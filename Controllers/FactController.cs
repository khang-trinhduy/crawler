...
{
    public class FactController : SpidersController
    {
        public FactController(CrawlerContext context, IConfiguration config) : base(context, config)
        {
        }
