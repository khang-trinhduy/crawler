...
{
    public class VnnetController : SpidersController
    {
        public VnnetController(CrawlerContext context, IConfiguration config) : base(context, config)
        {
        }
