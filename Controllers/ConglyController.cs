...
{
    public class ConglyController : SpidersController
    {
        public ConglyController(CrawlerContext context, IConfiguration config) : base(context, config)
        {
        }
