...
{
    public class VnbizController : SpidersController
    {
        public VnbizController(CrawlerContext context, IConfiguration config) : base(context, config)
        {
        }
