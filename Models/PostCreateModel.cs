    ...
    public class PostCreateModel
    {
        ...
        public static PostCreateModel Create(New n)
        {
            ...
            if (n.Tags != null && n.Tags.Trim() != string.Empty)
            {
                ...
                {
                    if (tag.Trim() == "topbank.vn" || tag.Trim() == "viettimes" || tag.Trim() == "vietnambiz" || tag.Trim() == "conglyxahoi.net.vn" || tag.Trim() == "www.sggp.org.vn" || tag.Trim() == "cafef.vn" || tag.Trim() == "vneconomy.vn" || tag.Trim() == "cuoi.tuoitre.vn" || tag.Trim() == "tuoitre.vn")
                    {
                        item.Sggp = true;
                    }
